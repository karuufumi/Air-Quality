            ...
            <div className="flex flex-col gap-y-2.5 w-full">
                ...
                <div className="w-full bg-white h-[124px] rounded-[19px] gap-x-1 shadow-md px-4 py-5 grid grid-cols-2 border">
                    <div className="flex flex-col gap-y-5 items-center">
                        ...
                        <div className="text-[18px] lg:text-[22px] font-bold text-[#4D4D4D]">{sensorvalues.temperatureC}</div>
                    </div>
                    <div className="flex flex-col gap-y-5 items-center">
                        <div className="text-[16px] lg:text-[17px] font-medium text-[#4D4D4D]">Degree Fahrenheit</div>
                        <div className="text-[18px] lg:text-[22px] font-bold text-[#4D4D4D]">{sensorvalues.temperatureF}</div>
                    </div>
                </div>
            </div>
            <div className="flex gap-x-6 w-full">
                <div className="flex flex-col gap-y-2.5 w-1/2">
                    ...
                    <div className="flex flex-col items-center gap-y-2.5 bg-white h-[124px] rounded-[19px] shadow-md px-4 py-5 border">
                        ...
                        <div className="text-[18px] lg:text-[22px] font-bold text-[#4D4D4D]">{sensorvalues.humidity}</div>
                    </div>
                </div>
                <div className="flex flex-col gap-y-2.5 w-1/2">
                    ...
                    <div className="flex flex-col items-center gap-y-2.5 bg-white h-[124px] rounded-[19px] shadow-md px-4 py-5 border">
                        ...
                        <div className="text-[18px] lg:text-[22px] font-bold text-[#4D4D4D]">{sensorvalues.lightIntensity}</div>
                    </div>
                </div>
            </div>
        </div>
